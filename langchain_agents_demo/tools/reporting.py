...
class ReportService:
    ...
    def generate_html_report(self, filename: str, html_content: str) -> str:
        ...
        try:
            log_function_call("generate_html_report", {
                "filename": filename,
            ...
            if file_path.exists():
                backup_path = self.report_dir / f"{clean_filename}_backup_{int(time.time())}.html"
            ...
            try:
                with open(file_path, 'w', encoding='utf-8') as f:
                    ...
                    if not self._is_complete_html(html_content):
                        html_content = self._wrap_in_html_structure(html_content, clean_filename)
                ...
                log_performance("generate_html_report", time.time() - start_time, {
            ...
            if isinstance(e, ReportingError):
                ...
                raise ReportingError(f"Unexpected error during report generation: {str(e)}") from e
